class ActiveCuponResponseModel {
  List<Data> data;
  String message;
  int code;

  ActiveCuponResponseModel({this.data, this.message, this.code});

  ActiveCuponResponseModel.fromJson(Map<String, dynamic> json) {
    if (json['data'] != null) {
      data = new List<Data>();
      json['data'].forEach((v) {
