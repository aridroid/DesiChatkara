 ...
 _updateCartBloc=UpdateCartBloc();
  ...
  //child: Image.asset("images/poke1.jpg")
      ...
      Container(
        ...
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
          Text(snapshot.data.data.cartItems[index].productName, style: new TextStyle(color: Colors.black,
                       fontSize: 14.0),),

          Padding(
            padding: const EdgeInsets.only(top:5.0,bottom:5.0),
            child: Text("1 plate", style: new TextStyle(color: Colors.grey,
                         fontSize: 14.0),),
          ),

                       Row(children: [
                            Text(snapshot.data.data.cartItems[index].unitPrice, style: new TextStyle(color: Colors.black,
                       fontSize: 14.0),),
       ...
       "quantity":count[index].toString()
          ...
          builder: (context, snapshot1){
          ...
          }):Icon(Icons.remove_circle,color: Colors.red[900],)
           ...
           Container(
             ...
             child: Text(
               count[index].toString(), style: new TextStyle(color: Colors.black,
                         fontSize: 16.0),),
           ),
       ...
       "quantity":count[index].toString()
          ...
          builder: (context, snapshot2){
            ...
            return Icon(Icons.add_circle,color: Colors.red[900],);
          }):Icon(Icons.add_circle,color: Colors.red[900],)
       ...
       Container(
               ...
               Row(children: [
                  Expanded(
                                    child: Container(
                                      ...
                                      child: Text("Delivery at", style: new TextStyle(color: Colors.white,
                           fontSize: 14.0),),
                                    ),
                  ),
               ...
               Padding(
                 ...
                 child: Row(children: [
                   Icon(Icons.location_on,color:Colors.white),
                    Text("ABC building , z road, delhi 54", style: new TextStyle(color: Colors.white,
                           fontSize: 14.0),),
                 ],),
               )
         ...
         Container(
           ...
           child: Column(children: [
             Row(children: [
                Expanded(
                                  child: Text("Item Total", style: new TextStyle(color: Colors.black,
                         fontSize: 14.0),),
                ),

                 Text(total_amount, style: new TextStyle(color: Colors.black,
                       fontSize: 14.0),),
              ],),
                ...
                Padding(
                  ...
                  child: Row(children: [
                  Expanded(
                                    child: Text("Delivery Charge", style: new TextStyle(color: Colors.black,
                           fontSize: 14.0),),
                  ),

                   Padding(
                     padding: const EdgeInsets.only(top:10.0),
                     child: Text(delivery_charge, style: new TextStyle(color: Colors.green,
                           fontSize: 14.0),),
                   ),
              ],),
                ),
         ...
         Container(
           ...
           child:Row(children: [
               Expanded(
                                child: Text("Total", style: new TextStyle(color: Colors.black,
                           fontSize: 14.0),),
               ),

               Text(total, style: new TextStyle(color: Colors.black,
                         fontSize: 14.0),),
           ],) ,),
  ...
  getCartId() async {
      ...
      preferencesCart=await SharedPreferences.getInstance();
          cartId=preferencesCart.getString("cartiddesichatkara");
...
class CartAppBar extends StatefulWidget with PreferredSizeWidget{
    ...
    CartAppBar(
        this.title,
        { Key key,}) : preferredSize = Size.fromHeight(140.0),
            super(key: key);
