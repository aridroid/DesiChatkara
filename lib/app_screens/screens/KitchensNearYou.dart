...
_kitchenNearRepository=KitchensNearRepository();
  ...
  Widget build(BuildContext context) {
   return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Kitchens Near You", style: new TextStyle(color: Colors.white,
                 fontSize: 17.0),),
        actions: [
          IconButton(
  ...
  decoration: BoxDecoration(
              borderRadius: BorderRadius.only(topLeft: Radius.circular(10.0),topRight: Radius.circular(10.0),),
                            image: DecorationImage(
                              ...
                              NetworkImage("https://deliveryontime.co.in/api/public"+snapshot.data.data[index].vendorImage),
  ...
  Container(
              ...
              child: Row(children: [
                             ...
                             Expanded(child: Text(snapshot.data.data[index].shopName, style: new TextStyle(color: Colors.black),)),
