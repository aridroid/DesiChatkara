...
import 'VerificationPageLoing.dart';

class LoginWithPhone extends StatefulWidget {

  final bool socialLogin;
  LoginWithPhone({this.socialLogin=false});
  @override
                        ...
                        onTap: () {
                          ...
                          if(ph.length==10){
                            Navigator.pushReplacement(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => VerificationPageLogin(mobileNumber: ph,socialLogin: widget.socialLogin,),
                                ));
                          }else{
